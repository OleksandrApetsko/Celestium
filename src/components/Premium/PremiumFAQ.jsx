  ...
  return (
    <section className="max-w-4xl mx-auto mt-32">
      ...
      <p className="text-white/60 text-center mt-3 mb-12">
        Clear guidance — so you know exactly what Premium offers.
      </p>
          ...
          return (
            ...
            >
              ...
              >
                ...
                <span className={`text-yellow-300 font-bold text-xl transition-transform ${open ? "rotate-45" : ""}`}>
                  +
                </span>
              </button>

              {open && (
                <p className="px-5 pb-5 text-white/75 leading-relaxed animate-fadeIn">
                  {item.a}
                </p>
              )}
            </div>
