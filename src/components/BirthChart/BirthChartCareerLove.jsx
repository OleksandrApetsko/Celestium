...
import { birthChartCareerLove } from "../../data/birthChart/birthChartCareerLove.js";

export default function BirthChartCareerLove({ data = birthChartCareerLove }) {
  const { header, sections, footer } = data;

  return (
    <Container>
      <section
        id="birthchart-career-love"
